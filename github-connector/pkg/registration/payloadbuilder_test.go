...
import (
	...
	"github.com/dekiel/github-slack-connectors/github-connector/pkg/registration/mocks"
...
func TestBuild(t *testing.T) {
	t.Run("should return proper values", func(t *testing.T) {
		...
		url := "https://raw.githubusercontent.com/kyma-incubator/github-slack-connectors/master/github-connector/pkg/registration/configs/githubopenAPI.json"
